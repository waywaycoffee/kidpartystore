        ...
        <div className="flex items-center justify-between px-4 h-16">
          <div className="flex items-center space-x-4">
            ...
            <Link href="/admin" className="flex items-center space-x-2">
              <span className="text-xl font-bold">KIDDKRAYS</span>
          ...
          <div className="flex items-center space-x-4 flex-1 max-w-2xl mx-8">
            ...
            <div className="relative flex-1">
              <input
                type="text"
                placeholder="搜索"
                className="w-full bg-gray-700 text-white placeholder-gray-400 px-4 py-2 pl-10 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <svg
            ...
            <button className="p-2 hover:bg-gray-700 rounded-lg" title="快捷键 ⌘K">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
